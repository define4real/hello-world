...
set_target_properties(LibreSSL::Crypto PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/crypto-55.dll"
  )

list(APPEND _cmake_import_check_targets LibreSSL::Crypto )
list(APPEND _cmake_import_check_files_for_LibreSSL::Crypto "${_IMPORT_PREFIX}/lib/crypto.lib" "${_IMPORT_PREFIX}/bin/crypto-55.dll" )
