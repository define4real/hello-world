...
set_target_properties(LibreSSL::SSL PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/ssl.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/ssl-58.dll"
  )

list(APPEND _cmake_import_check_targets LibreSSL::SSL )
list(APPEND _cmake_import_check_files_for_LibreSSL::SSL "${_IMPORT_PREFIX}/lib/ssl.lib" "${_IMPORT_PREFIX}/bin/ssl-58.dll" )
