...
set_target_properties(LibreSSL::TLS PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/tls-31.dll"
  )

list(APPEND _cmake_import_check_targets LibreSSL::TLS )
list(APPEND _cmake_import_check_files_for_LibreSSL::TLS "${_IMPORT_PREFIX}/lib/tls.lib" "${_IMPORT_PREFIX}/bin/tls-31.dll" )
